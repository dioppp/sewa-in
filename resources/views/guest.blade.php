        ...
        <div class="container-fluid p-0">
            <div class="row g-0">
                <div class="col-lg-4 col-sm-6">
                    <a class="portfolio-box" href="{{ asset('assets/img/sports/fullsize/sports-1.jpg') }}"
                        title="Project Name">
                ...
                <div class="col-lg-4 col-sm-6">
                    <a class="portfolio-box" href="{{ asset('assets/img/sports/fullsize/sports-5.jpg') }}"
                        title="Project Name">
                ...
                <div class="col-lg-4 col-sm-6">
                    <a class="portfolio-box" href="{{ asset('assets/img/sports/fullsize/sports-6.jpg') }}"
                        title="Project Name">
                ...
                <div class="col-lg-4 col-sm-6">
                    <a class="portfolio-box" href="{{ asset('assets/img/sports/fullsize/sports-2.jpg') }}"
                        title="Project Name">
                ...
                <div class="col-lg-4 col-sm-6">
                    <a class="portfolio-box" href="{{ asset('assets/img/sports/fullsize/sports-8.jpg') }}"
                        title="Project Name">
                ...
                <div class="col-lg-4 col-sm-6">
                    <a class="portfolio-box" href="{{ asset('assets/img/sports/fullsize/sports-11.jpg') }}"
                        title="Project Name">
