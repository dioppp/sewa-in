                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="{{ route('owner-field.store') }}" method="POST" custom-action enctype="multipart/form-data">
                                            @csrf
    ...
    <script>
        ...
        if (exampleModal) {
            exampleModal.addEventListener('show.bs.modal', event => {
                ...
                document.getElementById('editForm').setAttribute('action', '/owner-field/' + id);
    ...
    <script>
        ...
        if (deleteModal) {
            deleteModal.addEventListener('show.bs.modal', event => {
                const button = event.relatedTarget;
                const id = button.getAttribute('data-bs-id');
                document.getElementById('deleteForm').setAttribute('action', '/owner-field/' + id);
    ...
    <script>
        ...
        if (modalPhoto) {
            modalPhoto.addEventListener('show.bs.modal', event => {
                ...
                const modalBodyInputPhoto = modalPhoto.querySelector('#photo');
                modalBodyInputPhoto.src = '/storage/' + photo;
            })
        }
    </script>
@endpush
